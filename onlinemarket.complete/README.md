...
<VirtualHost *:80>
    ...
    DocumentRoot /path/to/onlinemarket.3/public
    <Directory /path/to/onlinemarket.3/public>
...
server {
    ...
    root         /path/to/onlinemarket.3/public;
    ...
    location @php {
        ...
        fastcgi_param  SCRIPT_FILENAME /path/to/onlinemarket.3/public/index.php;
